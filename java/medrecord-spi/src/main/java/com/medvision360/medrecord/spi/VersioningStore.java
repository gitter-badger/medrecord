 ...
 * Locatables, for example {@link org.openehr.rm.ehr.VersionedComposition}, {@link
 * org.openehr.rm.demographic.VersionedParty}, and {@link org.openehr.rm.common.directory.VersionedFolder}. This class
 * extends {@link LocatableStore} with explicit support for such versioned objects.
 * <p/>
 * Versioning store implementations SHOULD also implement {@link AuditedService} so that they can write audit entries
 * for all API invocations, not just those that provide {@link VersionedObject}. If they do so, the audit information
 * provided within {@link VersionedObject} MUST always override the audit information provided in {@link
 * AuditedService}.
 */
