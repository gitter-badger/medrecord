...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function delRelationship() {
      ...
      removePartyRelationship($("#relationshipid").val(), setResult);
    }
    /* delRelationship */
...
<body>
<h2>Call web API function 'removePartyRelationship'</h2>
Is passing the call to the openEHR kernel SOAP API DemographicService.removePartyRelationship<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/demographic-functions/removepartyrelationshipfromparty">Description</a><br/>
<br/>

<div>
  &nbsp; Relationship Id <input type="text" name="relationshipid" id="relationshipid" value="" size="50"/>

  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="delRelationship();"/>
</div>
<br/>
