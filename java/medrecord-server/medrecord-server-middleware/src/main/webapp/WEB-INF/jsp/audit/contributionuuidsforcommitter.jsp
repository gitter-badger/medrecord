...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getAuditInfo() {
      ...
      getContributionUUIDsForCommitter($("#personuid").val(), $("#begindate").val(), $("#enddate").val(), setResult);
    }
    /* getAuditInfo */
...
<body>
<h2>Call web API function 'getContributionUUIDsForCommitter'</h2>
Is passing the call to the openEHR kernel SOAP API AuditService.getContributionUUIDsForCommitter<br/>
<!-- <a href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/ehr-functions/getehruid">Description</a><br /> -->
<br/>

<div>
  &nbsp; Person id <input type="text" name="personuid" id="personuid" value="" size="50"/> <br/> &nbsp; Begin Date
  <input type="text" name="begindate" id="begindate" value="" size="50"/> (yyyyMMdd'T'HHmmss,SSS) <br/> &nbsp; End Date
