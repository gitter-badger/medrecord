...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function addContentItem() {
      ...
      addContentItemToSection($("#sectid").val(), $("#archid").val(), path, value, setResult);
    }
    /* addContentItem */
...
<body>
<h2>Call web API function 'addContentItemToSection'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.addContentItemToSection<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/addcontentitemtosection">Description</a><br/>
<br/>

<div>
  &nbsp; Section Id <input type="text" name="sectid" id="sectid" value="" size="50"/> <br/> &nbsp; Archetype Id <input
    type="text" name="archid" id="archid" value="" size="50"/> <br/>
  <ol id="input_list">
