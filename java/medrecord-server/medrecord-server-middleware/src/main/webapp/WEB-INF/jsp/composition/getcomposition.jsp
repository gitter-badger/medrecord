...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getComp() {
      ...
      if ($("#spn").prop("checked")) {
        retrieveCompositionSPN($("#uid").val(), $("#xmldata").prop("checked"), setResult);
      }
      else {
        retrieveComposition($("#uid").val(), $("#xmldata").prop("checked"), setResult);
      }
    }
    /* getComp */
...
<body>
<h2>Call web API function 'retrieveComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.retrieveComposition<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/retrievecomposition">Description</a><br/>
<br/>

<div>
  &nbsp; Composition Id <input type="text" name="uid" id="uid" value="30f88a1a-2008-402b-b093-091a321a78dc" size="50"/>
  <br/> &nbsp; <!--Use "Short Path Notation" <input type="checkbox" name="spn" id="spn"/> <br/> &nbsp;--> Return XML
   <input
    type="checkbox" name="xmldata" id="xmldata"/>
