...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getXPathQuery() {
      ...
      ehrXQueryFLWORNotation($("#query").val(), setResult);
    }
    /* getXPathQuery */
...
<body>
<h2>Call web API function 'ehrXQueryFLWORNotation'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.ehrXQueryFLWORNotation<br/>
