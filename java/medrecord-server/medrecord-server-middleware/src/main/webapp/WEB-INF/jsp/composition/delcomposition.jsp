...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function delComp() {
      ...
      deleteComposition($("#compid").val(), setResult);
    }
    /* delComp */
...
<body>
<h2>Call web API function 'deleteComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.deleteComposition<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/deletecomposition">Description</a><br/>
<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="delComp();"/>
</div>
<br/>
