...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getEhrId() {
      ...
      retrieveEhrIdForComposition($("#cuid").val(), setResult);
    }
    /* getArchId */
    ...
    function setResult(data) {
      if (data.errorcode != 0) {
        ...
        $("#result").text("Result of call: " + data.result);
      }
    }
    /* setResult */
...
<body>
<h2>Call web API function 'GetEHRUIDForComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.GetEHRUIDForComposition<br/> <a
...
<div>
  &nbsp; Composition Id <input type="text" name="cuid" id="cuid" value="" size="50"/>

  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="getEhrId();"/>
</div>
<br/>
