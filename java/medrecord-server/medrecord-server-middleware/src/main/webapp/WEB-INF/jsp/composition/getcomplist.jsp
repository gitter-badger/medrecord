...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getList() {
      ...
      retrieveCompositionList($("#ehrid").val(), setResult);
    }
    /* getList */
...
<body>
<h2>Call web API function 'retrieveCompositionList'</h2>
Is passing the call to the openEHR kernel SOAP API EHRService.retrieveCompositionList<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/retrievecompositionlist">Description</a><br/>
<br/>

<div>
  &nbsp; EHRID <input type="text" name="ehrid" id="ehrid" value="6e0e3b4e-69ab-4155-8765-454a424b3b8e" size="50"/>

  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="getList();"/>
</div>
<br/>
