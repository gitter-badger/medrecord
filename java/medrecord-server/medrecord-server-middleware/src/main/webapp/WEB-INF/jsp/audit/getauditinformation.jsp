...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getAuditInfo() {
      ...
      getAuditInformation($("#auditid").val(), setResult);
    }
    /* getAuditInfo */
...
<body>
<h2>Call web API function 'getAuditInformation'</h2>
Is passing the call to the openEHR kernel SOAP API AuditService.getAuditInformation<br/>
<!-- <a href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/ehr-functions/getehruid">Description</a><br /> -->
<br/>

<div>
  &nbsp; Audit id <input type="text" name="auditid" id="auditid" value="D749ABB3-09FA-4EDC-8FE7-2FA04985EC4D"
                         size="50"/>
