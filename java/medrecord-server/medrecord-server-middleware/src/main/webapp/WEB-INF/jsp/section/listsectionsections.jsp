...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function listSectionSections() {
      $("#result").html("Loading data...");
      setUserId(localStorage.userid);
      setSystemId(localStorage.systemid);
      listSectionsForSection($("#sectid").val(), setResult);
    }
    /* listSectionSections */
...
<body>
<h2>Call web API function 'listSectionsForSection'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.listSectionsForSection<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/listcontentsectionsforsections">Description</a><br/>
<br/>

<div>
  &nbsp; Section GUID <input type="text" name="sectid" id="sectid" value="" size="50"/>

  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="listSectionSections();"/>
</div>
<br/>
