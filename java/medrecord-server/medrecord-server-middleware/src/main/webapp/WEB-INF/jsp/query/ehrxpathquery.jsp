...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getXPathQuery() {
      ...
      ehrXPathQuery($("#query").val(), setResult);
    }
    /* getXPathQuery */
...
<body>
<h2>Call web API function 'ehrXPathQuery'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.ehrXPathQuery<br/>
