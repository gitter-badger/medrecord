...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function newComposition() {
      ...
      createComposition($("#ehrid").val(), path, value, setResult);
    }
    /* newComposition */
...
<body>
<h2>Call web API function 'createComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.createComposition<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/createcomposition">Description</a><br/>
<br/>

<div>
  &nbsp; EHRID <input type="text" name="ehrid" id="ehrid" value="" size="50"/> <br/>
  <ol id="input_list">
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="newComposition();"/>
</div>
<br/>
