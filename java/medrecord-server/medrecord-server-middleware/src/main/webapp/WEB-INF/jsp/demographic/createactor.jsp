...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function newActor() {
      ...
      createActor(path, value, setResult);
    }
    /* newActor */
...
<body>
<h2>Call web API function 'createActor'</h2>
Is passing the call to the openEHR kernel SOAP API DemographicService.saveDemographicNew<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/demographic-functions/createactor">Description</a><br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Save Result" name="GetResult" onclick="newActor();"/>
</div>
<p/>
