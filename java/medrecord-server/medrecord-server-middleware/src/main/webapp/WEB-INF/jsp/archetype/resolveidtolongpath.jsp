...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function resolvePathId() {
      ...
      resolveIdToLongPath($("#archid").val(), setResult);
    }
    /* resolvePathId */
...
<body>
<h2>Call web API function 'resolveIdToLongPath'</h2>
Is passing the call to the openEHR kernel SOAP API ArchetypeService.archetypePathUtilsResolveIDsToLongPaths<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/archetype-functions/resolveidtolongpath">Description</a><br/>
<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="resolvePathId();"/>
</div>
<br/>
