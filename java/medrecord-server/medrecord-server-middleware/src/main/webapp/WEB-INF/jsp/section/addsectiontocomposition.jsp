...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function addSection() {
      ...
      addSectionToComposition($("#compid").val(), $("#archid").val(), path, value, setResult);
    }
    /* addSection */
...
<body>
<h2>Call web API function 'addSectionToComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.addSectionToComposition<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/addsectiontocomposition">Description</a><br/>
<br/>

<div>
  &nbsp; Composition Id <input type="text" name="compid" id="compid" value="" size="50"/> <br/> &nbsp; Archetype Node Id
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="addSection();"/>
</div>
<br/>
