...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getXPathQuery() {
      ...
      demographicXPathQuery($("#query").val(), setResult);
    }
    /* getXPathQuery */
...
<body>
<h2>Call web API function 'demographicXPathQuery'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.demographicXPathQuery<br/>
