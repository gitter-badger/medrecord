...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function listCompositionSections() {
      $("#result").html("Loading data...");
      setUserId(localStorage.userid);
      setSystemId(localStorage.systemid);
      listSectionsForComposition($("#compid").val(), setResult);
    }
    /* listCompositionSections */
...
<body>
<h2>Call web API function 'listSectionsForComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.listSectionsForComposition<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/listcontentsectionsforcomposition">Description</a><br/>
<br/>

<div>
  &nbsp; Composition GUID <input type="text" name="compid" id="compid" value="" size="50"/>

  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="listCompositionSections();"/>
</div>
<br/>
