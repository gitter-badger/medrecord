...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function delEHRItem() {
      ...
      removeItemFromEHR($("#ehrid").val(), $("#itemid").val(), setResult);
    }
    /* delEHRItem */
...
<body>
<h2>Call web API function 'removeItemFromEHR'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.removeItemFromEHRItem<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/ehr-functions/removeitemfromehr">Description</a><br/>
<br/>

<div>
  &nbsp; EHR Id <input type="text" name="ehrid" id="ehrid" value="" size="50"/> <br/> &nbsp; Item Id <input type="text"
                                                                                                            name="itemid"
                                                                                                            id="itemid"
                                                                                                            value=""
                                                                                                            size="50"/>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="delEHRItem();"/>
</div>
<br/>
