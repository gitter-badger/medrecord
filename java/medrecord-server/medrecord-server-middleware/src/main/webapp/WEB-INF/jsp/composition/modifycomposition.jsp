...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function modComposition() {
      ...
      modifyComposition(path, value, setResult);
    }
    /* modComposition */
...
<body>
<h2>Call web API function 'modifyComposition'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.modifyComposition<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/modifycomposition">Description</a><br/>
<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="modComposition();"/>
</div>
<br/>
