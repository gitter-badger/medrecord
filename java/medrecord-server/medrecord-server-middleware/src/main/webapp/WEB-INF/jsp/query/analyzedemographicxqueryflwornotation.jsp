...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function analyzeXQuery() {
      $("#result").html("Loading data...");
      setUserId(localStorage.userid);
      setSystemId(localStorage.systemid);
      analyzeDemographicXQueryFLWORNotation($("#query").val(), setResult);
    }
    /* analyzeXQuery */
...
<body>
<h2>Call web API function 'analyzeDemographicXQueryFLWORNotation'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.analyzeDemographicXQueryFLWORNotation<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="analyzeXQuery();"/>
</div>
<br/>
