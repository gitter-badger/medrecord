...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function analyzeXPathQuery() {
      $("#result").html("Loading data...");
      setUserId(localStorage.userid);
      setSystemId(localStorage.systemid);
      analyzeEhrXQueryFLWORNotation($("#query").val(), setResult);
    }
    /* analyzeXPathQuery */
...
<body>
<h2>Call web API function 'analyzeEhrXQueryFLWORNotation'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.analyzeEhrXQueryFLWORNotation<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="analyzeXPathQuery();"/>
</div>
<br/>
