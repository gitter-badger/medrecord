...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getAuditInfo() {
      ...
      getVersionedObject($("#objectuid").val(), setResult);
    }
    /* getAuditInfo */
...
<body>
<h2>Call web API function 'getVersionedObject'</h2>
Is passing the call to the openEHR kernel SOAP API AuditService.getVersionedObject<br/>
<!-- <a href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/ehr-functions/getehruid">Description</a><br /> -->
<br/>

<div>
  &nbsp; Object id <input type="text" name="objectuid" id="objectuid" value="" size="50"/>
