...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function getAuditInfo() {
      ...
      getAuditUUIDsForPerson($("#personuid").val(), $("#begindate").val(), $("#enddate").val(), setResult);
    }
    /* getAuditInfo */
...
<body>
<h2>Call web API function 'getAuditUUIDsForPerson'</h2>
Is passing the call to the openEHR kernel SOAP API AuditService.getAuditUUIDsForPerson<br/>
