...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function addSection() {
      ...
      addSectionToSection($("#compid").val(), $("#archid").val(), path, value, setResult);
    }
    /* addSection */
...
<body>
<h2>Call web API function 'addSectionToSection'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.addSectionToSection<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/addsectiontosection">Description</a><br/>
<br/>
