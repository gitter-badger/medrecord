...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function analyzeXPathQuery() {
      ...
      analyzeDemographicXPathQuery($("#query").val(), setResult);
    }
    /* analyzeXPathQuery */
...
<body>
<h2>Call web API function 'analyzeDemographicXPathQuery'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.analyzeDemographicXPathQuery<br/>
