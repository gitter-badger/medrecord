...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function shortPath() {
      ...
      makeShortPath($("#lpath").val(), setResult);
    }
    /* shortPath */
...
<body>
<h2>Call web API function 'makeShortPath'</h2>
Is passing the call to the openEHR kernel SOAP API ArchetypeService.archetypePathUtilsMakeShortPath<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/archetype-functions/makeshortpath">Description</a><br/>
<br/>

<div>
  &nbsp; Long Path <input type="text" name="lpath" id="lpath" value="" size="75"/>

  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="shortPath();"/>
</div>
<br/>
