...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function analyzeXPathQuery() {
      ...
      analyzeEhrXPathQuery($("#query").val(), setResult);
    }
    /* analyzeXPathQuery */
...
<body>
<h2>Call web API function 'analyzeEhrXPathQuery'</h2>
Is passing the call to the openEHR kernel SOAP API LocatableService.analyzeEhrXPathQuery<br/>
