...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function listSectionItems() {
      ...
      listContentItemsForSection($("#sectid").val(), setResult);
    }
    /* listSectionItems */
...
<body>
<h2>Call web API function 'listContentItemsForSection'</h2>
Is passing the call to the openEHR kernel SOAP API CompositionService.listContentItemsForSection<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/composition-functions/listsectionitemsforcomposition">Description</a><br/>
<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="listSectionItems();"/>
</div>
<br/>
