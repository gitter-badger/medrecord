...
<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    function newEHR() {
      ...
      createEHR(path, value, setResult);
    }
    /* newEHR */
...
<body>
<h2>Call web API function 'createEHR'</h2>
Is passing the call to the openEHR kernel SOAP API EHRService.createEHR<br/> <a
    href="https://sites.google.com/a/zorggemak.com/archetypegui/middleware/ehr-functions/createehr">Description</a><br/>
<br/>
...
<div>
  ...
  <p/>
  <input type="submit" value="Get Result" name="GetResult" onclick="newEHR();"/>
</div>
<br/>
