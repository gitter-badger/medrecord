...
@ApiException(
        status  = 400,
        cause   = Cause.USER,
        code    = "INVALID_RANGE_ID_EXCEPTION",
        message = "Not a valid range: {0}"
)
public class InvalidRangeException extends RecordException
{
    ...
    public InvalidRangeException(Collection<String> arguments)
    {
        super(arguments);
    }
}
